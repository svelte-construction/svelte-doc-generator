...
class BasePartial extends SvelteSource_1.default {
    ...
    generate(variables = [], attributes = []) {
        ...
        const sourceVariable = create_1.default(Variable_1.default).configure({ value: source });
        const sourceAttribute = create_1.default(Attribute_1.default).configure({ name: 'source', value: sourceVariable });
